...
export class ReminderService {
  ...
  async findOne(id: string): Promise<PrismaReminder> {
  ...
  async update(id: string, input: UpdateReminderInput): Promise<PrismaReminder> {
    await this.findOne(id);
    const { reminder_id, ...updateData } = input;
  ...
  async remove(id: string): Promise<PrismaReminder> {
    await this.findOne(id);
