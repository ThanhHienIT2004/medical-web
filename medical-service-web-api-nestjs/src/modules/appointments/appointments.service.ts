...
export class AppointmentService {
  ...
  async create(input: CreateAppointmentInput): Promise<PrismaAppointment> {
    ...
    }) as any; // Cast to any temporarily if relations cause TS mismatch during migration
  ...
  async updateStatus(appointmentId: string, newStatus: string): Promise<PrismaAppointment> {
  ...
  async findOne(id: string): Promise<PrismaAppointment> {
    const appointment = await this.prisma.appointment.findUnique({
  ...
  async remove(id: string): Promise<PrismaAppointment> {
