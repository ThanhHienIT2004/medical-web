...
export interface DoctorTableProps<T>{
    headers: HeaderDoctorTable[]; // headers for table
    items: T[]; // items for table
    action: ActionDoctorTable; // action for table
}

const DoctorTable = <T,>(
    { headers, items, action }: DoctorTableProps<T>
) => {
